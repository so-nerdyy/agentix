...
```powershell
$env:AGENTIX_PACKAGE = "@nerdyy/agentix@2.1.11"
irm https://raw.githubusercontent.com/so-nerdyy/agentix/main/install.ps1 | iex
```

```sh
AGENTIX_PACKAGE=@nerdyy/agentix@2.1.11 curl -fsSL https://raw.githubusercontent.com/so-nerdyy/agentix/main/install.sh | sh
```
...
$env:AGENTIX_PACKAGE='.release/nerdyy-agentix-2.1.11.tgz'
...
```bash
npm run release:manifest
AGENTIX_PACKAGE=.release/nerdyy-agentix-2.1.11.tgz \
